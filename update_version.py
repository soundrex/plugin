...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright NisheethLahoti, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/SoundRex-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoundRex-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoundRex-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoundRex-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoundRex-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoundRex-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/SoundRex-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/SoundRex.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SoundRex.iss",inplace=1):
